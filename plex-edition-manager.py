...
def initialize_settings():
    ...
    if 'server' in config.sections():
        ...
        try:
            ...
            if language == 'zh':
                logger.error("服务器连接失败，请检查配置文件的设置是否有误。如需帮助，请访问 https://github.com/x1ao4/plex-edition-manager 查看使用说明。\n")
            else:
                logger.error("Server connection failed, please check the settings in the configuration file. For help, please visit https://github.com/x1ao4/plex-edition-manager for instructions. \n")
            time.sleep(10)
